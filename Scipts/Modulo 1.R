...
valor_c<-12L # Numeros enteros. Se puede crear variables sin dejar espacios sin embargo se recomienda dejar espacios por
print(valor_c)  # legibilidad y estilo profesional
