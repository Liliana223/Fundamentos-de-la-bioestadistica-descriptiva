...
# -------------------------------
valor_a <- 152 # Se sugiere no utilizar caracteres especiales, espacios, ni iniciar con numeros
...
array_3d <- array(1:24, dim = c(2, 3, 4)) # 2 filas, 3 columnas, 4 "capas" o "matrices"
print("Array 3D:")
print(array_3d)

# 4.1 Índices: [fila, columna, capa]. 3 DIMENSIONES. 3 ÍNDICES
...
# Usa read_table para leer un archivo CSV
...
# Dataset iris ya viene en R
data(iris)

# Ejemplo de manipulación con dplyr
iris_resumen <- iris %>%
...
ggplot(iris, aes(x = Species, y = Sepal.Length, fill = Species)) +
  geom_boxplot() +
  labs(
    title = "Distribución del largo del sépalo según especie",
    x = "Especie",
