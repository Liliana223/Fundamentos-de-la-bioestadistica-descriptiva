...
ggplot(iris, aes(x = Sepal.Length)) +
  ...
  labs(title = "Histograma de la Longitud del Sepalo", x = "Longitud (cm)", y = "Frecuencia")
```
...
species_counts$Fraccion <- species_counts$Frecuencia / sum(species_counts$Frecuencia) # 0.3333333
...
ggplot(species_counts, aes(x = "", y = Fraccion, fill = Especie)) +
  ...
  coord_polar("y") +
  labs(title = "Proporcion de especies (Diagrama de pastel)") +
  theme_void() +
  geom_text(aes(label = Etiqueta), position = position_stack(vjust = 0.5))

# El eje X no se usa en un gráfico de pastel (ya que es un gráfico circular, no cartesiano). Pero como geom_bar() necesita un eje X para crear las barras antes de convertirlas en pastel con coord_polar("y"), se usa x = "" como un valor constante y vacío para que todas las barras se alineen en el mismo punto.

# identity: Ya calculamos la frecuencia. Tambien funciona se debe utilizar si tuvieramos los valores calculados de proporciones o cantidades. ggplot usa esos valores tal cual.

# coord_polar: Convierte un gráfico de barras en coordenadas cartesianas en un gráfico circular
...
ggplot(iris, aes(x = Petal.Length, y = Petal.Width, color = Species)) +
  geom_point(size = 3) +
  labs(title = "Diagrama de dispersion: Petalo", x = "Longitud del petalo", y = "Ancho del petalo") +
  theme_light()
```
...
ggplot(iris, aes(x = Species, y = Sepal.Length, fill = Species)) +
  geom_boxplot() +
  labs(title = "Boxplot: Longitud del sepalo por especie", x = "Especie", y = "Longitud del sepalo") +
  theme_minimal()
```
...
ggplot(df, aes(x = valores)) +
  ...
  labs(
    title = "Distribucion con histograma y curva de densidad",
    subtitle = paste0("Asimetria = ", round(asimetria, 2), 
...
abline(h = cuartiles[3], col = "red", lty = 2)  # Mediana (Q2)
abline(h = cuartiles[2], col = "green", lty = 2) # Q1
abline(h = cuartiles[4], col = "orange", lty = 2) # Q3

# Agregar texto para identificar cada línea
text(x = 1.25, y = cuartiles[2], labels = "Q1. 25%", col = "green", pos = 3)
text(x = 1.25, y = cuartiles[3], labels = "Q2 (Mediana). 50%", col = "red", pos = 3)
text(x = 1.25, y = cuartiles[4], labels = "Q3. 75%", col = "orange", pos = 3)
...
# Agregar texto para identificar cada línea
text(x = 1.25, y = cuartiles[2], labels = "Q1", col = "green", pos = 3)
text(x = 1.25, y = cuartiles[3], labels = "Q2 (Mediana)", col = "red", pos = 3)
text(x = 1.25, y = cuartiles[4], labels = "Q3", col = "orange", pos = 3)
